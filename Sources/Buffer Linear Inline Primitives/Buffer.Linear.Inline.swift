...
extension Buffer.Linear.Inline where Element: ~Copyable {
    public enum Peek {
        public typealias View = Property<Buffer<Element>.Linear.Peek, Buffer<Element>.Linear.Inline<capacity>>.Borrow.Typed<Element>.Valued<capacity>
    }

    public enum Remove {
        public typealias View = Property<Buffer<Element>.Linear.Remove, Buffer<Element>.Linear.Inline<capacity>>.Inout.Typed<Element>.Valued<capacity>
    }
}
