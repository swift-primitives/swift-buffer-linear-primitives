...
extension Buffer.Linear.Bounded where Element: ~Copyable {
    public enum Peek {
        public typealias View = Property<Buffer<Element>.Linear.Peek, Buffer<Element>.Linear.Bounded>.Borrow.Typed<Element>
    }

    public enum Remove {
        public typealias View = Property<Buffer<Element>.Linear.Remove, Buffer<Element>.Linear.Bounded>.Inout.Typed<Element>
    }
}
