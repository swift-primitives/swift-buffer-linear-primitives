...
extension Buffer.Linear where Element: ~Copyable {
    ...
    public enum Peek {
        public typealias View = Property<Peek, Buffer<Element>.Linear>.Borrow.Typed<Element>
    }

    /// Tag type for `.remove` property extensions.
    public enum Remove {
        public typealias View = Property<Remove, Buffer<Element>.Linear>.Inout.Typed<Element>
    }
}
