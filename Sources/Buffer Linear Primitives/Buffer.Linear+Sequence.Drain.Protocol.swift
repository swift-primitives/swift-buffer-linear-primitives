...
// (iteration). Delegates the consuming loop to the type module's `_drain` package
// window rather than the now-`@usableFromInline internal` storage fields (refined-C).
