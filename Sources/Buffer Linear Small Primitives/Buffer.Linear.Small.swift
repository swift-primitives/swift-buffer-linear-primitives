...
extension Buffer.Linear.Small where Element: ~Copyable {
    public enum Peek {
        public typealias View = Property<Buffer<Element>.Linear.Peek, Buffer<Element>.Linear.Small<inlineCapacity>>.Borrow.Typed<Element>.Valued<inlineCapacity>
    }

    public enum Remove {
        public typealias View = Property<Buffer<Element>.Linear.Remove, Buffer<Element>.Linear.Small<inlineCapacity>>.Inout.Typed<Element>.Valued<inlineCapacity>
    }
}
...
where
    Tag == Buffer<Element>.Linear.Remove,
